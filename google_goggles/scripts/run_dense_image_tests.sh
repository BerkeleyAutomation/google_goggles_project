...
SAVE_DIR=$(rospack find google_goggles)/data/tests/dense
...
#cmd 100 #&& cmd 200 && cmd 300 && 
#cmd 400 && cmd 500 && cmd 750 && cmd 1000 && cmd 1500 && 
cmd 2000 && cmd 2500 && cmd 3000 && cmd 4000 && cmd 5000 && cmd 6000 && cmd 7000
